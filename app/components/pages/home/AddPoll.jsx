...
const AddPollModul = () => {
    ...
    async function handleSubmit(e) {
        ...
        setIsPending(true)
        await axios.post('http://localhost:3000/polls', requestArray)
        setOptions(["", ""])
        setPollName("")
        setIsPending(false)
    ...
    return (
        <>
            <button onClick={toggleModal} disabled={showAddPollModal} className='add-poll-button'>Add poll</button>
            {
                showAddPollModal && (
                    <>
                        ...
                        <main className="modal-container">
                            ...
                            <form disabled={isPending} onSubmit={handleSubmit} style={{ opacity: isPending ? 0.7 : 1 }} className="add-poll-form">
                                <label>
                                    <span>Question</span>
                                    <input onChange={(e) => setPollName(e.target.value)} value={pollName} type="text" required placeholder="What is your favorate color" />
                                </label>
                                <span>Options</span>
                                ...
                                <button onSubmit={handleSubmit} type="submit" className="create-option-button">
                                    {isPending ? (
